...
# Fix conda meta.yaml
with open("package/ffevaluation/meta.yaml", "r") as f:
    text = f.read()
...
with open("package/ffevaluation/meta.yaml", "w") as f:
    f.write(text)

# Set version in version file for __version__ variable
with open("ffevaluation/version.py", "r") as f:
    filedata = f.read()
# Replace the target string
filedata = filedata.replace("unpackaged", version)
# Write the file out again
with open("ffevaluation/version.py", "w") as f:
    f.write(filedata)
